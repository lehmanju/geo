...
fn collinear_intersection<F: GeoNum>(p: Line<F>, q: Line<F>) -> Option<LineIntersection<F>> {
    ...
    fn improper<F: GeoNum>(intersection: Coordinate<F>) -> LineIntersection<F> {
...
fn nearest_endpoint<F: GeoNum>(p: Line<F>, q: Line<F>) -> Coordinate<F> {
...
fn raw_line_intersection<F: GeoNum>(p: Line<F>, q: Line<F>) -> Option<Coordinate<F>> {
    todo!("make generic");
...
fn proper_intersection<F: GeoNum>(p: Line<F>, q: Line<F>) -> Coordinate<F> {
